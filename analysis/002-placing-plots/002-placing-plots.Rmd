...
read_chunk("./analysis/002-placing-plots/002-placing-plots.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r graph-1, echo = TRUE, results='show', message=message_chunks, fig.width = 12, fig.height=5, out.width = "900px"}
```

# Placed from File
```{r graph-2, echo = TRUE, results='show', message=message_chunks, fig.width = 12, fig.height=5, out.width = "900px"}
```
